...
void main()
{
    ...
    mat3 normalTransform = mat3(u_model.modelMatrix);
    ...
    // View direction to fragment world pos
    vec3 viewPos = u_camera.data.invView[3].xyz;
    outViewDir = normalize(wsPos.xyz - viewPos);
