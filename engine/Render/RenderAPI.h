...
namespace Mist
{
	...
	namespace RenderAPI
	{
		...
		void CmdBindDescriptorSet(CommandBuffer cmd, PipelineLayout pipelineLayout, VkPipelineBindPoint bindPoint, const DescriptorSet* setArray, uint32_t setCount, uint32_t firstSet, const uint32_t* dynamicOffsets = nullptr, uint32_t dynamicOffsetCount = 0);
		...
		void CmdBindComputeDescriptorSet(CommandBuffer cmd, PipelineLayout pipelineLayout, const DescriptorSet* setArray, uint32_t setCount, uint32_t firstSet, const uint32_t* dynamicOffsets = nullptr, uint32_t dynamicOffsetCount = 0);
