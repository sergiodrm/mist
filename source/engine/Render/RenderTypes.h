...
#undef _X_
	...
	namespace utils
	{
		...
		inline constexpr size_t GetPixelSizeFromFormat(EFormat format)
        {
            switch (format)
            {
                case FORMAT_R8_UNORM: return 1 * 1;
                case FORMAT_R8_SNORM: return 1 * 1;
                case FORMAT_R8_USCALED: return 1 * 1;
                case FORMAT_R8_SSCALED: return 1 * 1;
                case FORMAT_R8_UINT: return 1 * 1;
                case FORMAT_R8_SINT: return 1 * 1;
				case FORMAT_R8_SRGB: return 1 * 1;
                case FORMAT_R8G8_UNORM: return 1 * 2;
                case FORMAT_R8G8_SNORM: return 1 * 2;
                case FORMAT_R8G8_USCALED: return 1 * 2;
                case FORMAT_R8G8_SSCALED: return 1 * 2;
                case FORMAT_R8G8_UINT: return 1 * 2;
                case FORMAT_R8G8_SINT: return 1 * 2;
				case FORMAT_R8G8_SRGB: return 1 * 2;
                case FORMAT_R8G8B8_UNORM: return 1 * 3;
                case FORMAT_R8G8B8_SNORM: return 1 * 3;
                case FORMAT_R8G8B8_USCALED: return 1 * 3;
                case FORMAT_R8G8B8_SSCALED: return 1 * 3;
                case FORMAT_R8G8B8_UINT: return 1 * 3;
                case FORMAT_R8G8B8_SINT: return 1 * 3;
                case FORMAT_R8G8B8_SRGB: return 1 * 3;
                case FORMAT_B8G8R8_UNORM: return 1 * 3;
                case FORMAT_B8G8R8_SNORM: return 1 * 3;
                case FORMAT_B8G8R8_USCALED: return 1 * 3;
                case FORMAT_B8G8R8_SSCALED: return 1 * 3;
                case FORMAT_B8G8R8_UINT: return 1 * 3;
                case FORMAT_B8G8R8_SINT: return 1 * 3;
				case FORMAT_B8G8R8_SRGB: return 1 * 3;
                case FORMAT_R8G8B8A8_UNORM: return 1 * 4;
                case FORMAT_R8G8B8A8_SNORM: return 1 * 4;
                case FORMAT_R8G8B8A8_USCALED: return 1 * 4;
                case FORMAT_R8G8B8A8_SSCALED: return 1 * 4;
                case FORMAT_R8G8B8A8_UINT: return 1 * 4;
                case FORMAT_R8G8B8A8_SINT: return 1 * 4;
                case FORMAT_R8G8B8A8_SRGB: return 1 * 4;
                case FORMAT_B8G8R8A8_UNORM: return 1 * 4;
                case FORMAT_B8G8R8A8_SNORM: return 1 * 4;
                case FORMAT_B8G8R8A8_USCALED: return 1 * 4;
                case FORMAT_B8G8R8A8_SSCALED: return 1 * 4;
                case FORMAT_B8G8R8A8_UINT: return 1 * 4;
                case FORMAT_B8G8R8A8_SINT: return 1 * 4;
                case FORMAT_B8G8R8A8_SRGB: return 1 * 4;
                case FORMAT_A8B8G8R8_UNORM_PACK32: return 1 * 4;
                case FORMAT_A8B8G8R8_SNORM_PACK32: return 1 * 4;
                case FORMAT_A8B8G8R8_USCALED_PACK32: return 1 * 4;
                case FORMAT_A8B8G8R8_SSCALED_PACK32: return 1 * 4;
                case FORMAT_A8B8G8R8_UINT_PACK32: return 1 * 4;
                case FORMAT_A8B8G8R8_SINT_PACK32: return 1 * 4;
				case FORMAT_A8B8G8R8_SRGB_PACK32: return 1 * 4;
                case FORMAT_A2R10G10B10_UNORM_PACK32: return 4;
                case FORMAT_A2R10G10B10_SNORM_PACK32: return 4;
                case FORMAT_A2R10G10B10_USCALED_PACK32: return 4;
                case FORMAT_A2R10G10B10_SSCALED_PACK32: return 4;
                case FORMAT_A2R10G10B10_UINT_PACK32: return 4;
                case FORMAT_A2R10G10B10_SINT_PACK32: return 4;
                case FORMAT_A2B10G10R10_UNORM_PACK32: return 4;
                case FORMAT_A2B10G10R10_SNORM_PACK32: return 4;
                case FORMAT_A2B10G10R10_USCALED_PACK32: return 4;
                case FORMAT_A2B10G10R10_SSCALED_PACK32: return 4;
                case FORMAT_A2B10G10R10_UINT_PACK32: return 4;
				case FORMAT_A2B10G10R10_SINT_PACK32: return 4;
                case FORMAT_R16_UNORM: return 2;
                case FORMAT_R16_SNORM: return 2;
                case FORMAT_R16_USCALED: return 2;
                case FORMAT_R16_SSCALED: return 2;
                case FORMAT_R16_UINT: return 2;
                case FORMAT_R16_SINT: return 2;
				case FORMAT_R16_SFLOAT: return 2;
                case FORMAT_R16G16_UNORM: return 4;
                case FORMAT_R16G16_SNORM: return 4;
                case FORMAT_R16G16_USCALED: return 4;
                case FORMAT_R16G16_SSCALED: return 4;
                case FORMAT_R16G16_UINT: return 4;
                case FORMAT_R16G16_SINT: return 4;
				case FORMAT_R16G16_SFLOAT: return 4;
                case FORMAT_R16G16B16_UNORM: return 6;
                case FORMAT_R16G16B16_SNORM: return 6;
                case FORMAT_R16G16B16_USCALED: return 6;
                case FORMAT_R16G16B16_SSCALED: return 6;
                case FORMAT_R16G16B16_UINT: return 6;
                case FORMAT_R16G16B16_SINT: return 6;
				case FORMAT_R16G16B16_SFLOAT: return 6;
                case FORMAT_R16G16B16A16_UNORM: return 8;
                case FORMAT_R16G16B16A16_SNORM: return 8;
                case FORMAT_R16G16B16A16_USCALED: return 8;
                case FORMAT_R16G16B16A16_SSCALED: return 8;
                case FORMAT_R16G16B16A16_UINT: return 8;
                case FORMAT_R16G16B16A16_SINT: return 8;
				case FORMAT_R16G16B16A16_SFLOAT: return 8;
                case FORMAT_R32_UINT: return 4;
                case FORMAT_R32_SINT: return 4;
				case FORMAT_R32_SFLOAT: return 4;
                case FORMAT_R32G32_UINT: return 8;
                case FORMAT_R32G32_SINT: return 8;
				case FORMAT_R32G32_SFLOAT: return 8;
                case FORMAT_R32G32B32_UINT: return 12;
                case FORMAT_R32G32B32_SINT: return 12;
				case FORMAT_R32G32B32_SFLOAT: return 12;
                case FORMAT_R32G32B32A32_UINT: return 16;
                case FORMAT_R32G32B32A32_SINT: return 16;
				case FORMAT_R32G32B32A32_SFLOAT: return 16;
                case FORMAT_R64_UINT: return 8;
                case FORMAT_R64_SINT: return 8;
				case FORMAT_R64_SFLOAT: return 8;
                case FORMAT_R64G64_UINT: return 16;
                case FORMAT_R64G64_SINT: return 16;
				case FORMAT_R64G64_SFLOAT: return 16;
                case FORMAT_R64G64B64_UINT: return 24;
                case FORMAT_R64G64B64_SINT: return 24;
				case FORMAT_R64G64B64_SFLOAT: return 24;
                case FORMAT_R64G64B64A64_UINT: return 32;
                case FORMAT_R64G64B64A64_SINT: return 32;
