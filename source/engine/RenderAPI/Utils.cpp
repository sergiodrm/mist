...
namespace render
{
    namespace utils
    {
        ...
        const char* ConvertFormatToStr(Format format)
        {
            ...
            case Format_R16G16_SFixed5_NV: return "Format_R16G16_SFixed5_NV";
            case Format_A1B5G5R5_UNorm_Pack16_KHR: return "Format_A1B5G5R5_UNorm_Pack16_KHR";
            case Format_A8_UNorm_KHR: return "Format_A8_UNorm_KHR";
			}
			unreachable_code();
        ...
        const char* ConvertMemoryUsageToStr(MemoryUsage usage)
        {
			switch (usage)
			{
			case MemoryUsage_Unknown: return "MemoryUsage_Unknown";
            case MemoryUsage_Cpu: return "MemoryUsage_Cpu";
            case MemoryUsage_CpuCopy: return "MemoryUsage_CpuCopy";
            case MemoryUsage_CpuToGpu: return "MemoryUsage_CpuToGpu";
            case MemoryUsage_Gpu: return "MemoryUsage_Gpu";
            case MemoryUsage_GpuToCpu: return "MemoryUsage_GpuToCpu";
			}
			unreachable_code();
            return "MemoryUsage_Unknown";
        }
